...
/****** Object:  View [APP_EXCEL].[VW_RELATORIO_WEB_MIS_VPK_FIXA_TUDO]    Script Date: 11/29/2016 2:02:28 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [APP_EXCEL].[VW_RELATORIO_WEB_MIS_VPK_FIXA_TUDO]
AS
...
SELECT  
 ...
 WHERE
		...
		AND C.ID_SEGMENTO = 1
		AND C.SEG_DESCR IN ('VPK','VPK-GOV') 
