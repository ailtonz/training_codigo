INSERT INTO OPENROWSET('Microsoft.ACE.OLEDB.12.0','Excel 12.0 Xml;HDR=YES;IMEX=0;Database=\\172.16.0.11\siscob\CENARIO\4061549259_CENARIO.xlsm','SELECT * FROM [Dados$]') SELECT PROCV 
