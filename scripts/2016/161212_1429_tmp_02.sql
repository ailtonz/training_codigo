INSERT INTO OPENROWSET('Microsoft.ACE.OLEDB.12.0','Excel 12.0 Xml;HDR=YES;IMEX=0;Database=\\172.16.0.11\siscob\CENARIO\4061549259_CENARIO.xlsm','SELECT * FROM [Dados$]') 
SELECT PROCV 
		,ID
		...
		,CONVERT(DECIMAL(18,2),REPLACE(REPLACE(ISNULL(SALDO_CAR_30,0),'.',''),',','.')) AS SALDO_CAR_30
		...
		,CONVERT(DECIMAL(18,2),REPLACE(REPLACE(ISNULL(SOMA_FXE_PDD_30,0),'.',''),',','.')) AS SOMA_FXE_PDD_30
	...
	WHERE (ID_ANALISTA = '74' or ID_ANALISTA_TMP = '74') and RAIZ_GRUPO = '4061549259' 