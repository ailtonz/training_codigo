...
/****** Object:  Table [sch_Carga].[Tbl_Import_Car_Bombril]    Script Date: 4/26/2017 2:44:39 PM ******/
SET ANSI_NULLS ON
GO
...
--DROP TABLE [sch_Carga].[Tbl_Import_Car_Bombril]
CREATE TABLE [sch_Carga].[Tbl_Import_Car_Bombril](
