...
Do Until infile.atendofstream
	...
	For each objBIOS in colBIOS
	    objTextFile.WriteLine "Série" & vbTab & objBIOS.SerialNumber
	...
	For Each objItem in colItems
		...
		objTextFile.WriteLine "Descrição" & vbTab & objItem.Description
	...
	Set colSettings = objWMIService.ExecQuery ("Select * from Win32_ComputerSystem")
	For Each objComputer in colSettings
		objTextFile.WriteLine "Memória" & vbTab & objComputer.TotalPhysicalMemory
	Next
	...
	For Each objSoftware in colSoftware
		...
		objTextFile.WriteLine "Versão" & vbTab & objSoftware.Version
	Next
	...
	For Each objQuickFix in colQuickFixes
		...
		objTextFile.WriteLine "Descrição" & vbTab & objQuickFix.Description
	Next
	Set colAccounts = GetObject("WinNT://" & strComputer & "")
	colAccounts.Filter = Array("user")
    objTextFile.WriteLine
    objTextFile.WriteLine "Usuários Locais:"
	For Each objUser In colAccounts
		objTextFile.WriteLine "Usuário" & vbTab & objUser.Name 
	Next
	...
	objTextFile.WriteLine
	objTextFile.WriteLine "Informações de Disco:"
	For each objDisk in colDisks
		...
		objTextFile.WriteLine "Espaço Livre" & vbTab &  objDisk.FreeSpace
	Next
loop
Wscript.Echo "Inventario Concluído com Sucesso"