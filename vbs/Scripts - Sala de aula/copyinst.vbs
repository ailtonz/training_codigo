...
strProductName = "Internet Explorer 6"
...
strMsgError = "Setup cannot copy the " & strProductName & " files. After the automated setup finishes, " & chr(10) & _
		"complete the installation of the instructor computer by connecting this machine to " & chr(10) & _
		"the Internet and installing " & strProductName & " from www.microsoft.com/ie. " & chr(10) & _
		"Please note that this method of install has not been tested."
...
pathSet = Array("i386\en\ie6\")

' file to look for
lookfile = "ie6setup.exe"
...
sub copyfiles(path)
	...
	if not(fso.FolderExists("D:\IE6")) then fso.CreateFolder "D:\IE6"
	wshshell.Run "net share IE6=D:\IE6"
	on error resume next
		'copy setup folder
		sSrc = path & "\*.*"
		sDest = "D:\IE6" 
