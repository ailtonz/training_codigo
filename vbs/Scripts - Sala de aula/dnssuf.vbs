...
wshshell.Run "c:\setup\reg export HKLM\SYSTEM\CurrentControlSet\Services\TCPIP\Parameters\Interfaces c:\setup\holding\interfaces.reg /nt4", 6, true
...
fld.Delete
wshshell.Run "findfile.cmd", 6, true
