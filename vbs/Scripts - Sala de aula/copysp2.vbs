...
strProductName = "Windows XP Service Pack 1a"
...
sub copyfiles(path)
	...
	if not(fso.FolderExists("C:\WinXPSP1a")) then fso.CreateFolder "C:\WinXPSP1a"
'	wshshell.Run "net share WINXPSP1a=C:\WinXPSP1a"
	on error resume next
		'copy setup folder
		sSrc = path & "\*.*"
		sDest = "C:\WinXPSP1a" 
