...
'Docs
Const rDoc = "DecisionFactors"
Const rDocSpec = "defDecisionFactors.xml"
'Orgs
Const rSource = "Home Organization"
Const rDestination = "Approver"
'Port
Const rPort = "MailPort"
'Channel
Const rChannel = "MailChannel"
'XLANG Schedule
Const rXLANG = "c:\Data\POApproval\POApproval.skx"
'Email Information
Const rEmailTo = "mailto:<your email>"
Const rEmailFrom = "mailto:authagent@Home.com"
' Signature Info
'Const rSignName = "Home"
Const rSignReference = "authagent@Home.com, US, WA, Redmond, Home.com, Purchasing, Home"
' Certificate Information
'Const rEncryptName = "Approver"
Const rEncryptReference = "authagent@Approver.com, US, WA, Redmond, Approver.com, Purchasing, Approver"
...
Const BIZTALK_TRANSPORT_TYPE_SMTP = 8 'Specifies that this instance of the object selects a Simple Mail Transfer Protocol (SMTP) transport component. 
...
Const BIZTALK_USAGE_TYPE_ENCRYPTION = 1 'Specifies that this is an encryption certificate. 
Const BIZTALK_USAGE_TYPE_SIGNATURE = 2 'Specifies that this is a signature certificate. 
Const BIZTALK_USAGE_TYPE_BOTH = 4 'Specifies that this certificate is used for both encryption and signature. 
Const BIZTALK_STORE_TYPE_MY = 1 'Specifies that the certificate store is type MY. This store contains certificates authorized only by your organization. 
Const BIZTALK_STORE_TYPE_BIZTALK = 2 'Specifies that the certificate is stored in the dedicated BizTalk Server 2000 store. 
Const BIZTALK_ENCRYPTION_TYPE_NONE = 1 'Specifies that encryption is not used. 
Const BIZTALK_ENCRYPTION_TYPE_CUSTOM = 2 'Specifies custom encryption. 
Const BIZTALK_ENCRYPTION_TYPE_SMIME = 4 'Specifies Secure Multipurpose Internet Mail Extensions (S/MIME) encryption. 
Const BIZTALK_SIGNATURE_TYPE_NONE = 1 'Specifies that there is no signature. 
Const BIZTALK_SIGNATURE_TYPE_CUSTOM = 2 'Specifies the custom signature of the document. 
Const BIZTALK_SIGNATURE_TYPE_SMIME = 4 'Specifies the S/MIME signature of the document. 
...
Else
	...
	Channel.SignatureCertificateInfo.Reference = rSignReference
