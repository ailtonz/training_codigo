...
sub copyfiles(path)
	...
	if not(fso.FolderExists("D:\ActiveSync36")) then fso.CreateFolder "D:\ActiveSync36"
	wshshell.Run "net share ActiveSync36=D:\ActiveSync36"
	on error resume next
		'copy setup folder
		sSrc = path & "\MSASYNC.EXE"
		sDest = "D:\ActiveSync36" 
