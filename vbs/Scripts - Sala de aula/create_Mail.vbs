...
Const rReceive = "ApprovalSecure"
Const rPollingLocation = "c:\data\POApproval\PODrop"
Const rPollingFile = "myPO.txt" 
...
Const rDecryptName = "Home"
Const rDecryptReference = "authagent@Home.com, US, WA, Redmond, Home.com, Purchasing, Home"
' Signature Info
Const rSignName = "Buyer"
Const rSignReference = "authagent@Buyer.com, US, WA, Redmond, Buyer.com, Purchasing, Buyer"
...
Else
	...
	' Certificate Name and Usage and both read-only properties
	'Channel.DecryptionCertificateInfo.Name = rDecryptName
	Channel.DecryptionCertificateInfo.Reference = rDecryptReference
	Channel.DecryptionCertificateInfo.Store = BIZTALK_STORE_TYPE_MY
	'Channel.DecryptionCertificateInfo.Usage = BIZTALK_USAGE_TYPE_BOTH
	
	'Channel.VerifySignatureCertificateInfo.Name = rSignName
	Channel.VerifySignatureCertificateInfo.Reference = rSignReference
	Channel.VerifySignatureCertificateInfo.Store = BIZTALK_STORE_TYPE_BIZTALK
	'Channel.VerifySignatureCertificateInfo.Usage = BIZTALK_USAGE_TYPE_BOTH
