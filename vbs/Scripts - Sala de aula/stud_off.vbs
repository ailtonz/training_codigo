...
Select  Case lcname
	...
	Case Else
		wscript.Echo "Problema em stuadmin.vbs... O nome do computador não corresponde a nenhum dos nomes esperados de computador de aluno. Portanto, não foi possível adicionar ninguém ao grupo Usuários avançados."
end select
