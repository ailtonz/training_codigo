...
dim fs, drvPath
drvPath= inputbox ("Digite o drive que deseja obter informações","Aviso","c:")
set fs = createobject("scripting.filesystemobject")
set d = fs.GetDrive(drvPath)
   s = "Drive " & drvPath & " - " & vbcrlf
   s =s & "Volume: " & d.VolumeName & vbcrlf
   s =s & "Espaço Livre: " & d.FreeSpace/1048576 & " Mbytes" & vbcrlf
...
'				 & "Identificador: "&WshSysEnv("PROCESSOR_IDENTIFIER")
   ...
   '								EXERCÍCIOS
   '
   ' Crie um objeto network que exiba o nome do usuário e computador utilizados.
   ' Crie um objeto shell e exiba algumas variáveis de ambiente
