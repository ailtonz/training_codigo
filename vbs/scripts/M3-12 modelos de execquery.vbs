...
'==========================================================================
'carregar propriedades específicas da classe logicaldisk
set objsvc = getobject("Winmgmts:")
...
'==========================================================================
'A classe CIM_MediaAccessDevice possui várias subclasses, mas a consulta
'pode ser filtrada para retornar dados de uma classe específica
