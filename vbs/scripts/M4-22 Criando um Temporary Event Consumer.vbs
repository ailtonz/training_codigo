'==========================================================================
'
'para descobrir qual é o id da placa execute o código abaixo
'
...
'para filtrar o resultado acrescente a cláusula where abaixo
...
msgbox "Associators:" & vbnewline & txt & vbnewline _
	& vbnewline & "References:" & vbnewline & txt2 ,vbinformation, "Associators e Referências."