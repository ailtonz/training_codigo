'=============================================================================================
'
'                CONECTAR COM UM ÚNICO DISCO E VERIFICAR SE ESTA PRONTA
'
'
'=============================================================================================
...
'wscript.Echo "Drive não esta pronto"
'else
...
'				"Espaço Livre: ",formatnumber(disco.FreeSpace/1073741824,2),"GB",vbnewline,_
'				"Tipo de Sistema: ",disco.FileSystem,vbnewline,_
'				"Número de Série: ",disco.SerialNumber
'				
'end if				
'============================================================================================
'Acessar todos os discos da Máquina
'============================================================================================
'set fso = createobject("scripting.filesystemobject")
