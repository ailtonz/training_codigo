...
omyobj.getinfo
msg = "6 Propriedades Padrão:"& vbnewline 
...
msg = msg & vbnewline & "Propriedades Específicas de uma Classe:"& vbnewline 
...
'-------------------------- listando valores múltiplos de uma propriedade  -------------------------
...
next
wscript.Echo "Existem "& n & " usuários no grupo Sales."& vbnewline & vbnewline & txt