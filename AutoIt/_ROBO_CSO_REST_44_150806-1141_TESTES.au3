...
Func ExibeInterface()
	...
	#Region ### START - Form Aplication ###
		...
		Global $txtUsuario = GUICtrlCreateInput("e0643742", 104, 32, 153, 21)
		$lblName = GUICtrlCreateLabel("USUÁRIO :", 24, 32, 68, 17, $SS_RIGHT)
		GUICtrlSetTip(-1, "(com letra e dígito")

		Global	$txtSenha = GUICtrlCreateInput("vivo1988", 424, 32, 161, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_PASSWORD))
		...
		Global	$txtNome = GUICtrlCreateInput("PEDRO", 104, 104, 153, 21)
		GUICtrlSetTip(-1, "(com letra e dígito")

		Global	$txtSenhaQry = GUICtrlCreateInput("arjud", 424, 104, 161, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_PASSWORD))
		$lblNome = GUICtrlCreateLabel("NOME :", 24, 104, 48, 17, $SS_RIGHT)
		$lblSenhaQry = GUICtrlCreateLabel("SENHA :", 352, 104, 54, 17, $SS_RIGHT)

		Global	$txtArea = GUICtrlCreateInput("SFR", 104, 136, 153, 21)
		GUICtrlSetTip(-1, "(com letra e dígito")
...
Func ValidaInterface()
	...
	Else
		$sAnalista[$eUsuario]			=	GUICtrlRead($txtUsuario) 	;	"e0643742"
		$sAnalista[$eSenha]				=	GUICtrlRead($txtSenha) 		;	"vivo1988"
		$sAnalista[$eNome]				=	GUICtrlRead($txtNome) 		;	"PEDRO"
		$sAnalista[$eSenhaQry]			=	GUICtrlRead($txtSenhaQry) 	;	"arjud"
		$sAnalista[$eArea]				=	GUICtrlRead($txtArea) 		;	"SFR"
...
;~ 						   _ShowStatus("SALVAR STATUS" & " "  & $x & "-" & $iRowCount )
